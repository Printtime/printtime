...
class CreatePaysTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('pays', function (Blueprint $table) {
            ...
            $table->decimal('sender_commission', 8, 2);
            $table->decimal('receiver_commission', 8, 2);
            $table->decimal('agent_commission', 8, 2);
            $table->decimal('amount_debit', 8, 2);
            $table->decimal('amount_credit', 8, 2);
            $table->decimal('commission_debit', 8, 2);
            $table->decimal('commission_credit', 8, 2);
            $table->string('currency_debit');
            $table->string('currency_credit');
            $table->decimal('sender_bonus', 8, 2);
            $table->decimal('amount_bonus', 8, 2);
